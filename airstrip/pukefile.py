...
# console.info("toto", "toto")
# console.info((("toto", "toto"), ("titi", "titi")))
...
#     # Travis is broken right now because of json
#     if trav:
...
#         # XXX Uber dirty for bootstrap
#         puke.sh('cd "%s"; make bootstrap' % p, output = True)
